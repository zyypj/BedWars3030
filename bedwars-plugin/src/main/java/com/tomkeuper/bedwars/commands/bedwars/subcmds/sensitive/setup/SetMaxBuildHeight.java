...
public class SetMaxBuildHeight extends SubCommand {
    ...
    public boolean execute(String[] args, CommandSender s) {
        ...
        if (args.length == 0) {
            p.sendMessage("§c▪ §7Uso: /" + com.tomkeuper.bedwars.BedWars.mainCmd + " setMaxBuildHeight <int>");
        } else {
            try {
            ...
            p.sendMessage("§6 ▪ §7Altura máxima de construção (Y) definida como §e" + args[0] + "§7!");
        }
        return true;
    }
