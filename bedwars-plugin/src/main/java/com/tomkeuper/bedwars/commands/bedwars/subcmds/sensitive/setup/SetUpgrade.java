    ...
    public boolean execute(String[] args, CommandSender s) {
        ...
        if (args.length == 0) {
            ...
            if (foundTeam.isEmpty()) {
                ...
                p.spigot().sendMessage(Misc.msgHoverClick(ss.getPrefix() + "Ou, se você definiu o spawn e ele não foi encontrado automaticamente, tente usar: /bw " + getSubCommandName() + " <team>", "Define o NPC de melhorias de um time.", "/" + getParent().getName() + " " + getSubCommandName() + " ", ClickEvent.Action.SUGGEST_COMMAND));
            ...
            if (ss.getConfig().getYml().get("Team." + args[0]) == null) {
                ...
                p.sendMessage(ss.getPrefix() + "NPC de melhorias definido para: " + team);
