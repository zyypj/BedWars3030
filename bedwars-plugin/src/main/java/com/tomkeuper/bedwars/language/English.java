...
public class English extends Language {
    ...
    public English() {
        ...
        addDefaultStatsMsg(yml, "geral", "&aOverall", "&fLevel: %bw_level%", "&fXP: &a%bw_current_xp%&7/&b%bw_required_xp%", "", "&fGames played: &a%bw_games_played%", "", "&fBeds broken: &a%bw_beds%", "&fBeds lost: &a%bw_beds_lost%", "", "&fKills: &a%bw_kills%", "&fDeaths: &a%bw_deaths%", "&fAssists: &a%bw_assists%", "&fFinal kills: &a%bw_final_kills%", "&fFinal deaths: &a%bw_final_deaths%", "&fFinal assists: &a%bw_final_assists%", "", "&fWins: &a%bw_wins%", "&fLosses: &a%bw_losses%", "", "&fWinstreak: &a%bw_winstreak%", "&fBest winstreak: &a%bw_best_winstreak%");
        addDefaultStatsMsg(yml, "solo", "&aSolo", "&fGames played: &a%bw_solo_games_played%", "", "&fBeds broken: &a%bw_solo_beds%", "&fBeds lost: &a%bw_solo_beds_lost%", "", "&fKills: &a%bw_solo_kills%", "&fDeaths: &a%bw_solo_deaths%", "&fAssists: &a%bw_solo_assists%", "&fFinal kills: &a%bw_solo_final_kills%", "&fFinal deaths: &a%bw_solo_final_deaths%", "&fFinal assists: &a%bw_solo_final_assists%", "", "&fWins: &a%bw_solo_wins%", "&fLosses: &a%bw_solo_losses%", "", "&fWinstreak: &a%bw_solo_winstreak%", "&fBest winstreak: &a%bw_solo_best_winstreak%");
        addDefaultStatsMsg(yml, "duplas", "&aDuplas", "&fGames played: &a%bw_duplas_games_played%", "", "&fBeds broken: &a%bw_duplas_beds%", "&fBeds lost: &a%bw_duplas_beds_lost%", "", "&fKills: &a%bw_duplas_kills%", "&fDeaths: &a%bw_duplas_deaths%", "&fAssists: &a%bw_duplas_assists%", "&fFinal kills: &a%bw_duplas_final_kills%", "&fFinal deaths: &a%bw_duplas_final_deaths%", "&fFinal assists: &a%bw_duplas_final_assists%", "", "&fWins: &a%bw_duplas_wins%", "&fLosses: &a%bw_duplas_losses%", "", "&fWinstreak: &a%bw_duplas_winstreak%", "&fBest winstreak: &a%bw_duplas_best_winstreak%");
        addDefaultStatsMsg(yml, "trios", "&aTrios", "&fGames played: &a%bw_trios_games_played%", "", "&fBeds broken: &a%bw_trios_beds%", "&fBeds lost: &a%bw_trios_beds_lost%", "", "&fKills: &a%bw_trios_kills%", "&fDeaths: &a%bw_trios_deaths%", "&fAssists: &a%bw_trios_assists%", "&fFinal kills: &a%bw_trios_final_kills%", "&fFinal deaths: &a%bw_trios_final_deaths%", "&fFinal assists: &a%bw_trios_final_assists%", "", "&fWins: &a%bw_trios_wins%", "&fLosses: &a%bw_trios_losses%", "", "&fWinstreak: &a%bw_trios_winstreak%", "&fBest winstreak: &a%bw_trios_best_winstreak%");
        addDefaultStatsMsg(yml, "quartetos", "&aQuartetos", "&fGames played: &a%bw_quartetos_games_played%", "", "&fBeds broken: &a%bw_quartetos_beds%", "&fBeds lost: &a%bw_quartetos_beds_lost%", "", "&fKills: &a%bw_quartetos_kills%", "&fDeaths: &a%bw_quartetos_deaths%", "&fAssists: &a%bw_quartetos_assists%", "&fFinal kills: &a%bw_quartetos_final_kills%", "&fFinal deaths: &a%bw_quartetos_final_deaths%", "&fFinal assists: &a%bw_quartetos_final_assists%", "", "&fWins: &a%bw_quartetos_wins%", "&fLosses: &a%bw_quartetos_losses%", "", "&fWinstreak: &a%bw_quartetos_winstreak%", "&fBest winstreak: &a%bw_quartetos_best_winstreak%");
        addDefaultStatsMsg(yml, "1v1", "&a1v1", "&fGames played: &a%bw_1v1_games_played%", "", "&fBeds broken: &a%bw_1v1_beds%", "&fBeds lost: &a%bw_1v1_beds_lost%", "", "&fKills: &a%bw_1v1_kills%", "&fDeaths: &a%bw_1v1_deaths%", "&fAssists: &a%bw_1v1_assists%", "&fFinal kills: &a%bw_1v1_final_kills%", "&fFinal deaths: &a%bw_1v1_final_deaths%", "&fFinal assists: &a%bw_1v1_final_assists%", "", "&fWins: &a%bw_1v1_wins%", "&fLosses: &a%bw_1v1_losses%", "", "&fWinstreak: &a%bw_1v1_winstreak%", "&fBest winstreak: &a%bw_1v1_best_winstreak%");
        addDefaultStatsMsg(yml, "2v2", "&a2v2", "&fGames played: &a%bw_2v2_games_played%", "", "&fBeds broken: &a%bw_2v2_beds%", "&fBeds lost: &a%bw_2v2_beds_lost%", "", "&fKills: &a%bw_2v2_kills%", "&fDeaths: &a%bw_2v2_deaths%", "&fAssists: &a%bw_2v2_assists%", "&fFinal kills: &a%bw_2v2_final_kills%", "&fFinal deaths: &a%bw_2v2_final_deaths%", "&fFinal assists: &a%bw_2v2_final_assists%", "", "&fWins: &a%bw_2v2_wins%", "&fLosses: &a%bw_2v2_losses%", "", "&fWinstreak: &a%bw_2v2_winstreak%", "&fBest winstreak: &a%bw_2v2_best_winstreak%");
        addDefaultStatsMsg(yml, "3v3", "&a3v3", "&fGames played: &a%bw_3v3_games_played%", "", "&fBeds broken: &a%bw_3v3_beds%", "&fBeds lost: &a%bw_3v3_beds_lost%", "", "&fKills: &a%bw_3v3_kills%", "&fDeaths: &a%bw_3v3_deaths%", "&fAssists: &a%bw_3v3_assists%", "&fFinal kills: &a%bw_3v3_final_kills%", "&fFinal deaths: &a%bw_3v3_final_deaths%", "&fFinal assists: &a%bw_3v3_final_assists%", "", "&fWins: &a%bw_3v3_wins%", "&fLosses: &a%bw_3v3_losses%", "", "&fWinstreak: &a%bw_3v3_winstreak%", "&fBest winstreak: &a%bw_3v3_best_winstreak%");
        addDefaultStatsMsg(yml, "4v4", "&a4v4", "&fGames played: &a%bw_4v4_games_played%", "", "&fBeds broken: &a%bw_4v4_beds%", "&fBeds lost: &a%bw_4v4_beds_lost%", "", "&fKills: &a%bw_4v4_kills%", "&fDeaths: &a%bw_4v4_deaths%", "&fAssists: &a%bw_4v4_assists%", "&fFinal kills: &a%bw_4v4_final_kills%", "&fFinal deaths: &a%bw_4v4_final_deaths%", "&fFinal assists: &a%bw_4v4_final_assists%", "", "&fWins: &a%bw_4v4_wins%", "&fLosses: &a%bw_4v4_losses%", "", "&fWinstreak: &a%bw_4v4_winstreak%", "&fBest winstreak: &a%bw_4v4_best_winstreak%");
        ...
        yml.addDefault("scoreboard.Solo.playing", Arrays.asList("&e&lBED WARS", "&7%bw_date%", "", "&f%bw_next_event% in &a%bw_time%", "", "%bw_team_1%", "%bw_team_2%", "%bw_team_3%", "%bw_team_4%", "%bw_team_5%", "%bw_team_6%", "%bw_team_7%", "%bw_team_8%", "", "&e%bw_server_ip%"));
        yml.addDefault("scoreboard.Duplas.playing", Arrays.asList("&e&lBED WARS", "&7%bw_date%", "", "&f%bw_next_event% in &a%bw_time%", "", "%bw_team_1%", "%bw_team_2%", "%bw_team_3%", "%bw_team_4%", "%bw_team_5%", "%bw_team_6%", "%bw_team_7%", "%bw_team_8%", "", "&e%bw_server_ip%"));
        yml.addDefault("scoreboard.Trios.playing", Arrays.asList("&e&lBED WARS", "&7%bw_date%", "", "&f%bw_next_event% in &a%bw_time%", "", "%bw_team_1%", "%bw_team_2%", "%bw_team_3%", "%bw_team_4%", "", "&fKills: &a%bw_kills%", "&fFinal Kills: &a%bw_final_kills%", "&fBeds Destroyed: &a%bw_beds%", "", "&e%bw_server_ip%"));
        yml.addDefault("scoreboard.Quartetos.playing", Arrays.asList("&e&lBED WARS", "&7%bw_date%", "", "&f%bw_next_event% in &a%bw_time%", "", "%bw_team_1%", "%bw_team_2%", "%bw_team_3%", "%bw_team_4%", "", "&fKills: &a%bw_kills%", "&fFinal Kills: &a%bw_final_kills%", "&fBeds Destroyed: &a%bw_beds%", "", "&e%bw_server_ip%"));
        yml.addDefault("scoreboard.1v1.playing", Arrays.asList("&e&lBED WARS", "&7%bw_date%", "", "&f%bw_next_event% in &a%bw_time%", "", "%bw_team_1%", "%bw_team_2%", "", "&fKills: &a%bw_kills%", "&fFinal Kills: &a%bw_final_kills%", "&fBeds Destroyed: &a%bw_beds%", "", "&e%bw_server_ip%"));
        yml.addDefault("scoreboard.2v2.playing", Arrays.asList("&e&lBED WARS", "&7%bw_date%", "", "&f%bw_next_event% in &a%bw_time%", "", "%bw_team_1%", "%bw_team_2%", "", "&fKills: &a%bw_kills%", "&fFinal Kills: &a%bw_final_kills%", "&fBeds Destroyed: &a%bw_beds%", "", "&e%bw_server_ip%"));
        yml.addDefault("scoreboard.3v3.playing", Arrays.asList("&e&lBED WARS", "&7%bw_date%", "", "&f%bw_next_event% in &a%bw_time%", "", "%bw_team_1%", "%bw_team_2%", "", "&fKills: &a%bw_kills%", "&fFinal Kills: &a%bw_final_kills%", "&fBeds Destroyed: &a%bw_beds%", "", "&e%bw_server_ip%"));
        yml.addDefault("scoreboard.4v4.playing", Arrays.asList("&e&lBED WARS", "&7%bw_date%", "", "&f%bw_next_event% in &a%bw_time%", "", "%bw_team_1%", "%bw_team_2%", "", "&fKills: &a%bw_kills%", "&fFinal Kills: &a%bw_final_kills%", "&fBeds Destroyed: &a%bw_beds%", "", "&e%bw_server_ip%"));
