...
public class Portuguese extends Language {
    ...
    public Portuguese() {
        ...
        yml.addDefault(Messages.ARENA_IN_GAME_ANNOUNCEMENT, Arrays.asList("&c&lSe você for desconectado, use /rejoin para voltar ao jogo.", "&c&lNão é permitido formar alianças com o time adversário! Denuncie usando /report."));
        ...
        yml.addDefault(Messages.GAME_END_TOP_PLAYER_CHAT, Arrays.asList(
                ...
                "%bw_winner_format%",
                "",
                "&e                          &l1º Assassino &7- %bw_first_format% - %bw_first_kills%",
                "&6                          &l2º Assassino &7- %bw_second_format% - %bw_second_kills%",
                "&c                          &l3º Assassino &7- %bw_third_format% - %bw_third_kills%",
                "",
                "&a▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"));
        ...
        addDefaultStatsMsg(yml, "geral", "&aGeral", "&fNível: %bw_level%", "&fXP: &a%bw_current_xp%&7/&b%bw_required_xp%", "", "&fPartidas: &a%bw_games_played%", "", "&fCamas quebradas: &a%bw_beds%", "&fCamas perdidas: &a%bw_beds_lost%", "", "&fKills: &a%bw_kills%", "&fMortes: &a%bw_deaths%", "&fAssistências: &a%bw_assists%", "&fKills finais: &a%bw_final_kills%", "&fMortes finais: &a%bw_final_deaths%", "&fAssistências finais: &a%bw_final_assists%", "", "&fVitórias: &a%bw_wins%", "&fDerrotas: &a%bw_losses%", "", "&fWinstreak: &a%bw_winstreak%", "&fMaior Winstreak: &a%bw_best_winstreak%");
        addDefaultStatsMsg(yml, "solo", "&aSolo", "&fPartidas: &a%bw_solo_games_played%", "", "&fCamas quebradas: &a%bw_solo_beds%", "&fCamas perdidas: &a%bw_solo_beds_lost%", "", "&fKills: &a%bw_solo_kills%", "&fMortes: &a%bw_solo_deaths%", "&fAssistências: &a%bw_solo_assists%", "&fKills finais: &a%bw_solo_final_kills%", "&fMortes finais: &a%bw_solo_final_deaths%", "&fAssistências finais: &a%bw_solo_final_assists%", "", "&fVitórias: &a%bw_solo_wins%", "&fDerrotas: &a%bw_solo_losses%", "", "&fWinstreak: &a%bw_solo_winstreak%", "&fMaior Winstreak: &a%bw_solo_best_winstreak%");
        addDefaultStatsMsg(yml, "duplas", "&aDuplas", "&fPartidas: &a%bw_duplas_games_played%", "", "&fCamas quebradas: &a%bw_duplas_beds%", "&fCamas perdidas: &a%bw_duplas_beds_lost%", "", "&fKills: &a%bw_duplas_kills%", "&fMortes: &a%bw_duplas_deaths%", "&fAssistências: &a%bw_duplas_assists%", "&fKills finais: &a%bw_duplas_final_kills%", "&fMortes finais: &a%bw_duplas_final_deaths%", "&fAssistências finais: &a%bw_duplas_final_assists%", "", "&fVitórias: &a%bw_duplas_wins%", "&fDerrotas: &a%bw_duplas_losses%", "", "&fWinstreak: &a%bw_duplas_winstreak%", "&fMaior Winstreak: &a%bw_duplas_best_winstreak%");
        addDefaultStatsMsg(yml, "trios", "&aTrios", "&fPartidas: &a%bw_trios_games_played%", "", "&fCamas quebradas: &a%bw_trios_beds%", "&fCamas perdidas: &a%bw_trios_beds_lost%", "", "&fKills: &a%bw_trios_kills%", "&fMortes: &a%bw_trios_deaths%", "&fAssistências: &a%bw_trios_assists%", "&fKills finais: &a%bw_trios_final_kills%", "&fMortes finais: &a%bw_trios_final_deaths%", "&fAssistências finais: &a%bw_trios_final_assists%", "", "&fVitórias: &a%bw_trios_wins%", "&fDerrotas: &a%bw_trios_losses%", "", "&fWinstreak: &a%bw_trios_winstreak%", "&fMaior Winstreak: &a%bw_trios_best_winstreak%");
        addDefaultStatsMsg(yml, "quartetos", "&aQuartetos", "&fPartidas: &a%bw_quartetos_games_played%", "", "&fCamas quebradas: &a%bw_quartetos_beds%", "&fCamas perdidas: &a%bw_quartetos_beds_lost%", "", "&fKills: &a%bw_quartetos_kills%", "&fMortes: &a%bw_quartetos_deaths%", "&fAssistências: &a%bw_quartetos_assists%", "&fKills finais: &a%bw_quartetos_final_kills%", "&fMortes finais: &a%bw_quartetos_final_deaths%", "&fAssistências finais: &a%bw_quartetos_final_assists%", "", "&fVitórias: &a%bw_quartetos_wins%", "&fDerrotas: &a%bw_quartetos_losses%", "", "&fWinstreak: &a%bw_quartetos_winstreak%", "&fMaior Winstreak: &a%bw_quartetos_best_winstreak%");
        addDefaultStatsMsg(yml, "1v1", "&a1v1", "&fPartidas: &a%bw_1v1_games_played%", "", "&fCamas quebradas: &a%bw_1v1_beds%", "&fCamas perdidas: &a%bw_1v1_beds_lost%", "", "&fKills: &a%bw_1v1_kills%", "&fMortes: &a%bw_1v1_deaths%", "&fAssistências: &a%bw_1v1_assists%", "&fKills finais: &a%bw_1v1_final_kills%", "&fMortes finais: &a%bw_1v1_final_deaths%", "&fAssistências finais: &a%bw_1v1_final_assists%", "", "&fVitórias: &a%bw_1v1_wins%", "&fDerrotas: &a%bw_1v1_losses%", "", "&fWinstreak: &a%bw_1v1_winstreak%", "&fMaior Winstreak: &a%bw_1v1_best_winstreak%");
        addDefaultStatsMsg(yml, "2v2", "&a2v2", "&fPartidas: &a%bw_2v2_games_played%", "", "&fCamas quebradas: &a%bw_2v2_beds%", "&fCamas perdidas: &a%bw_2v2_beds_lost%", "", "&fKills: &a%bw_2v2_kills%", "&fMortes: &a%bw_2v2_deaths%", "&fAssistências: &a%bw_2v2_assists%", "&fKills finais: &a%bw_2v2_final_kills%", "&fMortes finais: &a%bw_2v2_final_deaths%", "&fAssistências finais: &a%bw_2v2_final_assists%", "", "&fVitórias: &a%bw_2v2_wins%", "&fDerrotas: &a%bw_2v2_losses%", "", "&fWinstreak: &a%bw_2v2_winstreak%", "&fMaior Winstreak: &a%bw_2v2_best_winstreak%");
        addDefaultStatsMsg(yml, "3v3", "&a3v3", "&fPartidas: &a%bw_3v3_games_played%", "", "&fCamas quebradas: &a%bw_3v3_beds%", "&fCamas perdidas: &a%bw_3v3_beds_lost%", "", "&fKills: &a%bw_3v3_kills%", "&fMortes: &a%bw_3v3_deaths%", "&fAssistências: &a%bw_3v3_assists%", "&fKills finais: &a%bw_3v3_final_kills%", "&fMortes finais: &a%bw_3v3_final_deaths%", "&fAssistências finais: &a%bw_3v3_final_assists%", "", "&fVitórias: &a%bw_3v3_wins%", "&fDerrotas: &a%bw_3v3_losses%", "", "&fWinstreak: &a%bw_3v3_winstreak%", "&fMaior Winstreak: &a%bw_3v3_best_winstreak%");
        addDefaultStatsMsg(yml, "4v4", "&a4v4", "&fPartidas: &a%bw_4v4_games_played%", "", "&fCamas quebradas: &a%bw_4v4_beds%", "&fCamas perdidas: &a%bw_4v4_beds_lost%", "", "&fKills: &a%bw_4v4_kills%", "&fMortes: &a%bw_4v4_deaths%", "&fAssistências: &a%bw_4v4_assists%", "&fKills finais: &a%bw_4v4_final_kills%", "&fMortes finais: &a%bw_4v4_final_deaths%", "&fAssistências finais: &a%bw_4v4_final_assists%", "", "&fVitórias: &a%bw_4v4_wins%", "&fDerrotas: &a%bw_4v4_losses%", "", "&fWinstreak: &a%bw_4v4_winstreak%", "&fMaior Winstreak: &a%bw_4v4_best_winstreak%");
