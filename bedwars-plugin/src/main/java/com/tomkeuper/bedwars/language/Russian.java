...
public class Russian extends Language{
    ...
    public Russian() {
        ...
        yml.addDefault(Messages.COMMAND_MAIN, Arrays.asList("", "&2▪ &7/" + BedWars.mainCmd + " stats", "&2▪ &7/" + BedWars.mainCmd + " join &o<арена/тип>", "&2▪ &7/" + BedWars.mainCmd + " leave", "&2▪ &7/" + BedWars.mainCmd + " lang", "&2▪ &7/" + BedWars.mainCmd + " gui", "&2▪ &7/" + BedWars.mainCmd + " start &3(vip)"));
        ...
        yml.addDefault(Messages.FORMATTING_CHAT_SHOUT, "%bw_level%%bw_v_prefix%&6[ВСЕМ] %bw_team_format% &7%bw_player%&f%bw_v_suffix%: %bw_message%");
        ...
        yml.addDefault(Messages.PLAYER_HIT_BOW, "&7У %bw_lang_prefix%%bw_player% &7теперь &c%bw_damage_amount% &7HP!");
        ...
        yml.addDefault(Messages.COMMAND_JOIN_USAGE, "§a▪ §7Используйте: /" + BedWars.mainCmd + " join §o<арена/тип>");
    ...
    public void generateNPCMessages(YamlConfiguration yml, String group){
        yml.addDefault(Messages.NPC_NAME_TEAM_UPGRADES.replace("%group%", group), Arrays.asList("&bКОМАНДНЫЕ УЛУЧШЕНИЯ", "&e&lПКМ"));
        yml.addDefault(Messages.NPC_NAME_SOLO_UPGRADES.replace("%group%", group), Arrays.asList("&bСОЛО УЛУЧШЕНИЯ", "&e&lПКМ"));
        yml.addDefault(Messages.NPC_NAME_TEAM_SHOP.replace("%group%", group), Arrays.asList("&bМАГАЗИН", "&e&lПКМ"));
        yml.addDefault(Messages.NPC_NAME_SOLO_SHOP.replace("%group%", group), Arrays.asList("&bМАГАЗИН", "&e&lПКМ"));
    }
}