package com.tomkeuper.bedwars.support.version.v1_20_6.despawnable;
...
public abstract class DespawnableProvider<T> {
    ...
    protected void applyDefaultSettings(org.bukkit.entity.@NotNull LivingEntity bukkitEntity, DespawnableAttributes attr,
        ...
        Objects.requireNonNull(entity.f(GenericAttributes.q)).a(attr.health());
        Objects.requireNonNull(entity.f(GenericAttributes.r)).a(attr.speed());
