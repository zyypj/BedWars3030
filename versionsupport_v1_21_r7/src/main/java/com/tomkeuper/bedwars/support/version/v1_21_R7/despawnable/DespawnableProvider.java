package com.tomkeuper.bedwars.support.version.v1_21_R7.despawnable;
...
public abstract class DespawnableProvider<T> {
    ...
    protected void applyDefaultSettings(org.bukkit.entity.@NotNull LivingEntity bukkitEntity, DespawnableAttributes attr,
        ...
        Objects.requireNonNull(entity.fw().a(GenericAttributes.u)).a(attr.health());
        Objects.requireNonNull(entity.fw().a(GenericAttributes.x)).a(attr.speed());
        Objects.requireNonNull(entity.fw().a(GenericAttributes.d)).a(attr.damage());
    }
}
